...
{
    struct student_node *student_temp=(struct student_node *)malloc(sizeof(struct student_node));
...
struct student_node *add_node(struct student_node *head, struct student_data student_new)
{
